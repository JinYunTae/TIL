...
![image-20220328223947624](Django2(Model).assets/image-20220328223947624.png)
...
![image-20220328224504415](Django2(Model).assets/image-20220328224504415.png)

* list_display
  * models.py에 정의한 각각의 속성(칼럼)들의 값(레코드)을 admin 페이지에 출력하도록 설정
...
![image-20220328225032350](Django2(Model).assets/image-20220328225032350.png)

![image-20220328225118636](Django2(Model).assets/image-20220328225118636.png)

index 페이지 작성

![image-20220328225215681](Django2(Model).assets/image-20220328225215681.png)

READ - 전체 게시글 조회

![image-20220328225328313](Django2(Model).assets/image-20220328225328313.png)

CREATE - New views

![image-20220328225409686](Django2(Model).assets/image-20220328225409686.png)

CREATE - Create views

![image-20220328225451701](Django2(Model).assets/image-20220328225451701.png)
...
![image-20220328230122565](Django2(Model).assets/image-20220328230122565.png)
...
![image-20220328230305025](Django2(Model).assets/image-20220328230305025.png)
